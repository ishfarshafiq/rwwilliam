	  ...
	  //bkLib.onDomLoaded(nicEditors.allTextAreas);
		...
		function confirmation_announcement_delete(newsID) {
		  swal({
			...
			if (isDelete) {
			  location.href = "DeleteController.php?newsID=" + newsID;
			} else {
        ...
        <div class="admin-content">
            <div class="panel">
                <div class="panel-header">
                    ...
                    <button class="btn-add" data-bs-toggle="modal" data-bs-target="#addNews"><i class="bi bi-plus-lg"></i> Add Announcement</button>
                </div>
									...
									<tr>
										...
										<td>
											<div class="action-btns">
												<button class="action-btn" onclick="viewAnnouncement(<?php echo $row['newsID'];?>)" data-bs-toggle="modal" data-bs-target="#editNews" title="Edit"><i class="bi bi-pencil"></i></button>
												<button class="action-btn delete" onclick='confirmation_announcement_delete(<?php echo $row['newsID']; ?>)' title="Delete"><i class="bi bi-trash"></i></button>
											</div>
										</td>
			...
			<form action="Controller.php" method="POST" enctype="multipart/form-data" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input class="form-input" id="title" name="title" placeholder="Announcement title">
					</div>
					...
					<div class="form-group">
						<label>Image</label>
						<div class="img-upload-area"><i class="bi bi-cloud-arrow-up d-block"></i><p>Click or drag image here</p>
						<input type="file" accept="image/*" id="image" name="image" onchange="handleImgUpload(event)"></div>
					...
					<div class="row g-3">
						<div class="col-md-6">
							...
							<select class="form-input" id="icon" name="icon">
								<option value="bi-megaphone">Megaphone</option>
								<option value="bi-receipt">Receipt</option>
								<option value="bi-building-add">Building</option>
								<option value="bi-calendar-event">Calendar</option>
								<option value="bi-exclamation-triangle">Alert</option>
				...
				<div class="modal-footer">
					<button class="btn btn-primary" type="submit" name="addAnnouncement" id="addAnnouncement">Create Announcement</button>
				</div>
			</form>
		...
		<div class="modal-dialog modal-lg">
			...
			<form action="Controller.php" method="POST" enctype="multipart/form-data" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<input type="hidden" class="form-input" id="newsID" name="newsID" required />
				
					<div class="form-group">
						<label>Title <span class="required">*</span></label>
						<input class="form-input" id="edit_title" name="edit_title" placeholder="Announcement title">
					</div>
					...
					<div class="form-group">
						<label>Date</label>
						<input class="form-input" type="date" id="edit_publish_date" name="edit_publish_date">
					</div>
					
					<div class="form-group">
						<label>Image</label>
						<div class="img-upload-area"><i class="bi bi-cloud-arrow-up d-block"></i><p>Click or drag image here</p>
						<input type="file" accept="image/*" id="edit_image" name="edit_image" onchange="edit_handleImgUpload(event)"></div>
					...
					<div class="form-group">
						<label>Author</label>
						<input class="form-input" type="text" id="edit_author" name="edit_author">
					</div>
					...
					<div class="row g-3">
						<div class="col-md-6">
							<div class="form-group mb-0">
							<label>Icon (if no image)</label>
							<select class="form-input" id="edit_icon" name="edit_icon">
								<option value="bi-megaphone">Megaphone</option>
								<option value="bi-receipt">Receipt</option>
								<option value="bi-building-add">Building</option>
								<option value="bi-calendar-event">Calendar</option>
				...
				<div class="modal-footer">
					<button class="btn btn-primary" type="submit" name="editAnnouncement" id="editAnnouncement">Save Announcement</button>
				</div>
			</form>
