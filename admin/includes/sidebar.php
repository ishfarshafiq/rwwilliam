...
?>
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a class="nav-item-link <?= ($current_page == 'banners') ? 'active' : '' ?>" href="banners.php"><i class="bi bi-images"></i> Home Banners <span class="nav-badge" id="bannerCount">0</span></a>
            <a class="nav-item-link <?= ($current_page == 'announcements') ? 'active' : '' ?>" href="announcements.php"><i class="bi bi-megaphone"></i> Announcements <span class="nav-badge" id="annCount">0</span></a>
            <a class="nav-item-link <?= ($current_page == 'gallery') ? 'active' : '' ?>" href="gallery.php"><i class="bi bi-camera"></i> Gallery Albums <span class="nav-badge" id="galleryCount">0</span></a>
