    ...
    <main class="admin-main">
        ...
        <div class="admin-content">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-3 col-sm-6"><div class="stat-card"><div class="stat-icon blue"><i class="bi bi-images"></i></div><div class="stat-info"><h3 id="statBanners"><?php echo $count_banner;?></h3><p>Home Banners</p></div></div></div>
                <div class="col-lg-3 col-sm-6"><div class="stat-card"><div class="stat-icon green"><i class="bi bi-megaphone"></i></div><div class="stat-info"><h3 id="statAnn"><?php echo $count_news;?></h3><p>Announcements</p></div></div></div>
                <div class="col-lg-3 col-sm-6"><div class="stat-card"><div class="stat-icon amber"><i class="bi bi-camera"></i></div><div class="stat-info"><h3 id="statAlbums"><?php echo $count_album;?></h3><p>Gallery Albums</p></div></div></div>
                <div class="col-lg-3 col-sm-6"><div class="stat-card"><div class="stat-icon red"><i class="bi bi-image"></i></div><div class="stat-info"><h3 id="statPhotos"><?php echo $count_images;?></h3><p>Total Photos</p></div></div></div>
            </div>
            ...
            <div class="panel mb-4">
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-md-4"><a href="banners.php" class="btn-add w-100 justify-content-center text-decoration-none"><i class="bi bi-plus-lg"></i> Add New Banner</a></div>
                        <div class="col-md-4"><a href="announcements.php" class="btn-add w-100 justify-content-center text-decoration-none"><i class="bi bi-plus-lg"></i> Add Announcement</a></div>
                        <div class="col-md-4"><a href="gallery.php" class="btn-add w-100 justify-content-center text-decoration-none"><i class="bi bi-plus-lg"></i> Add Gallery Album</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="panel">
                        <div class="panel-header"><h5><i class="bi bi-megaphone"></i> Latest Announcements</h5><a href="announcements.php" class="btn-add" style="padding:6px 14px;font-size:12px">View All</a></div>
                        <div class="panel-body p-0"><table class="admin-table"><tbody id="recentAnnBody"></tbody></table></div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="panel">
                        <div class="panel-header"><h5><i class="bi bi-camera"></i> Latest Albums</h5><a href="gallery.php" class="btn-add" style="padding:6px 14px;font-size:12px">View All</a></div>
