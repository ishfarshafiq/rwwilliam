            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="text-lg-end" data-aos="fade-left">
                        <a href="contacts.php" class="office-tag">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 text-lg-end" data-aos="fade-left">
                    <a href="contact.php" class="btn-rw-primary me-2 d-inline-block mb-2">Get in Touch</a>
                    <a href="services.php" class="btn-rw-outline d-inline-block mb-2">Our Services</a>
                </div>
            </div>
        </div>
    </section>
