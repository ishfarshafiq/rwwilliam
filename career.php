...
<body>
    ...
    <div class="top-bar d-none d-lg-block">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a href="/cdn-cgi/l/email-protection#22504b414a435046625055554b4e4e4b434f0c414d4f0c4f5b"><i class="bi bi-envelope me-1"></i>
                        <span class="__cf_email__" data-cfemail="0d7f646e656c7f694d7f7a7a646161646c60236e6260236074">[email&#160;protected]</span></a>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <nav class="mobile-menu-nav"><a href="index.html" class="mobile-nav-link">Home <i
                    ...
                    <a href="news-announcement.html" class="mobile-nav-link active">News <i
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <ul class="footer-contact p-0">
                        <li><i class="bi bi-geo-alt"></i><span>Petaling Jaya, Selangor Darul Ehsan, Malaysia</span></li>
                        <li><i class="bi bi-telephone"></i><span>+603-7805 3859</span></li>
                        <li><i class="bi bi-envelope"></i><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="13617a707b726177536164647a7f7f7a727e3d707c7e3d7e6a">[email&#160;protected]</a></span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-md-end">
                        <div class="footer-social"><a href="#"><i class="bi bi-facebook"></i></a><a href="#"><i
                                    class="bi bi-linkedin"></i></a><a href="#"><i class="bi bi-instagram"></i></a><a
                                href="#"><i class="bi bi-twitter-x"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border:none;border-radius:20px;overflow:hidden;text-align:center">
                <div class="modal-body" style="padding:48px 32px">
                    ...
                    <h3 style="font-family:var(--font-heading);color:var(--rw-accent);margin-bottom:12px">Application Submitted!</h3>
                    <p style="color:var(--rw-text-light);margin-bottom:8px;font-size:16px">Thank you for your interest in joining <strong style="color:var(--rw-accent)">RW William PLT</strong>.</p>
                    <p style="color:var(--rw-text-light);font-size:14px;margin-bottom:28px">We have received your application and our HR team will review it shortly. We'll be in touch via email if your profile matches our requirements.</p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border:none;border-radius:20px;overflow:hidden;text-align:center">
                <div class="modal-body" style="padding:48px 32px">
                    ...
                    <h3 style="font-family:var(--font-heading);color:var(--rw-accent);margin-bottom:12px">Submission Failed</h3>
    ...
    <div id="socialSidebar" class="social-sidebar open">
        <div class="social-sidebar-links">
            ...
            <a href="/cdn-cgi/l/email-protection#097b606a61687b6d497b7e7e606565606864276a6664276470" class="social-email">
    ...
    <script>
        ...
        // Form submission via AJAX to PHP
        document.getElementById('careerForm').addEventListener('submit', function (e) {
            ...
            formData.append('hire', document.getElementById('hire').value);
            formData.append('resume', fileInput.files[0]);

            fetch('submit_career.php', {
                method: 'POST',
                body: formData
            })
